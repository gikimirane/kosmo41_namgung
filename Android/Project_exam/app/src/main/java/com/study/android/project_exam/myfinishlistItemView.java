...
public class myfinishlistItemView extends LinearLayout {
    private static final String TAG = "lecture";
    TextView mycode;
    TextView myprice;
    TextView mymenu;

    public myfinishlistItemView(final Context context) {
        super(context);

        LayoutInflater inflater =
                (LayoutInflater)context.getSystemService(context.LAYOUT_INFLATER_SERVICE);
        inflater.inflate(R.layout.myfinishlist_item_view,this,true);
